...
import 'messestand_detail_screen.dart';
    ...
    return Scaffold(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                // Gets the current messestand.
                final messestand = messestaende[index];

                // Gets all images that belong to this messestand.
                final bilder =
                    (messestand['bilder'] ?? []) as List<dynamic>;

                // Gets the first image if at least one image exists.
                final firstBild =
                    bilder.isNotEmpty ? bilder[0] : null;
                ...
                return Card(
                  ...
                  // Makes the complete messestand card clickable.
                  child: InkWell(
                    // Opens the detail page of the selected messestand.
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) =>
                              MessestandDetailScreen(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          // Displays the first image if one exists.
                          if (firstBild != null) ...[
                            ClipRRect(
                              borderRadius:
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          ...
          // Reloads the messestaende after returning
          // from the personal area.
          getMessestaende(
            skill: skillSearch,
            district: districtSearch,
            maxPrice: maxPriceSearch,
