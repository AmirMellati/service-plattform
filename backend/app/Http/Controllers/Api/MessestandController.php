...
{
    // Returns all messestaende and supports different filters.
    public function index(Request $request): JsonResponse
    {
        // Loads the messestaende together with their related data.
        $query = Messestand::with([
            'user',
            'skills',
            'einsatzgebiet',
            'bilder',
        ...
        // Filters messestaende by skill name.
        ...
        // Filters messestaende by district.
    ...
    {
        // Validates the entered messestand data.
        ...
        // Stops the request if the entered service area is invalid.
        if (!$isValidServiceArea) {
            return response()->json([
                'message' =>
                    'Das angegebene Einsatzgebiet wurde nicht gefunden.',
            ], 422);
        }
        ...
        // This is not the handwerker's private address.
        ...
        // Returns the newly created messestand with all related data.
        return response()->json(
            $messestand->load([
                'user',
                'skills',
    ...
    public function update(
        ...
        // Checks whether the updated service area really exists.
        $isValidServiceArea = $geocodingService->validateServiceArea(
            $validated['city'],
            $validated['district']
        );
    ...
    public function destroy(
        ...
        return response()->json([
            'message' =>
                'Messestand wurde erfolgreich gelöscht.',
        ]);
    }
    ...
    public function activateFeatured(
        ...
        return response()->json([
            'message' =>
                'Featured wurde für einen Monat aktiviert.',
            'messestand' => $messestand,
        ]);
    }
}